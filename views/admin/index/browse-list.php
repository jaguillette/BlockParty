		...
		<tr>
			<td>
				...
				<ul class="action-links group">
					<li><a class="edit" href="<?php echo html_escape(record_url('tag_everything_tag_page', 'edit')); ?>">
						<?php echo __('Edit'); ?>
					</a></li>
					<li><a class="delete-confirm" href="<?php echo html_escape(record_url('tag_everything_tag_page', 'delete-confirm')); ?>">
						<?php echo __('Delete'); ?>
					</a></li>
				</ul>
			</td>
			...
			<td><?php echo html_escape(format_date(metadata('tag_everything_tag_page', 'updated'), Zend_Date::DATETIME_SHORT)); ?></td>
		</tr>
	<?php endforeach; ?>
	</tbody>
</table>